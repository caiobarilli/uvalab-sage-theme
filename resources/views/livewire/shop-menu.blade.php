<div class="shop-menu">
    ...
    <button class="site-header__toggle" id="menu-toggle" aria-label="{{ __('Menu', 'sage') }}" aria-expanded="false"
        onclick="document.getElementById('site-nav').classList.toggle('is-open'); this.classList.toggle('is-open'); this.setAttribute('aria-expanded', this.classList.contains('is-open'));">
