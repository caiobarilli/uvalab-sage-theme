...
use App\Livewire\Admin\AcornCache;
use Brain\Monkey;
...
test('clear bloqueia usuario sem permissao', function () {
    Functions\expect('current_user_can')
        ->once()
        ->with('manage_options')
        ->andReturn(false);

    $component = new AcornCache;
    $component->clear();
...
test('render retorna a view do componente', function () {
    ...
    expect($result->view)->toBe('livewire.admin.acorn-cache');
});
